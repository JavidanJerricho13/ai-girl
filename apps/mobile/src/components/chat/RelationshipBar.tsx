...
const LEVELS = [
  { min: 0, max: 10, label: 'Stranger', emoji: '👋', color: '#71717A' },
  { min: 10, max: 30, label: 'Acquaintance', emoji: '🤝', color: '#6366F1' },
  { min: 30, max: 100, label: 'Friend', emoji: '💙', color: '#3B82F6' },
  { min: 100, max: 300, label: 'Close', emoji: '💜', color: '#8B5CF6' },
  { min: 300, max: Infinity, label: 'Intimate', emoji: '❤️', color: '#EC4899' },
];
